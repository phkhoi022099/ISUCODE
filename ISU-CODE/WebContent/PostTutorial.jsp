...
String category= request.getParameter("code");
 ...
 str = "insert into tutorials(Title,Text1,Category) values('" + title + "','" + text + "','" + category + "');";
 System.out.println(str);
 int i = st.executeUpdate("insert into tutorials(Title,Text1,Category) values('" + title + "','" + text + "','" + category + "');");
