...
<!-- Debugging LANGUAGES -->
    ...
    <div class="container">
            ...
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <ul class="nav nav-pills nav-stacked">
                    	<li><a href="JavaQ.html" class="text-danger">JAVA</a></li>
		...
		<div class="container">
		<div class="col-md-9">
		<form class="form"   action="PostQuestion.jsp" method="POST" >  
  		...
  		<textarea class="form-control" name ="q"aria-label="With textarea"></textarea>
  		<span class="input-group-text">CODE LANGUAGE</span>
  		<textarea class="form-control" name ="category" aria-label="With textarea"></textarea>
	...
	<div class="col-md-9">
	<h2>your questions and answeres</h2>
...
String sql ="select * from question where UserQID = \"d@isu.edu\"";
String text = "";
