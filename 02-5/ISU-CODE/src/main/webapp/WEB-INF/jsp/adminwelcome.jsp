    	...
    	<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="row">
<%-- <a  href="${pageContext.request.contextPath}/isucode/addTutorial" class="btn btn-primary">Add Tutorial</a>
<a  href="${pageContext.request.contextPath}/isucode/viewTutorial" class="btn btn-success">View Tutorial</a>
<a  href="${pageContext.request.contextPath}/isucode/viewUsers" class="btn btn-success">View Users</a>
 --%>
      <h1>Hi</h1> <h3>${user.name}</h3>

											<%-- <a href="${pageContext.request.contextPath}/isucode/adminPage" class="btn btn-primary">Go to Admin Part</a>  --%>
					</div>
				</div>
	</div>
			</div>
