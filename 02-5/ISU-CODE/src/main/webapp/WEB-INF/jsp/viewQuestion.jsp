			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="row">
                      ...
                      <tbody>
						 <c:forEach items="${questioins}" var="q">
						 <tr><td>${q.qid}</td><td>${q.question}</td><td>${q.answer}</td><td>${q.userEmail}</td><td>
						 <c:forEach items="${q.posts}" var="userPost">
						   <p><b>==>></b>${userPost.post}</p><br>
						 </c:forEach>
						 </td>
						 <td><a  href="${pageContext.request.contextPath}/isucode/viewParticularQuestion/${q.qid}" class="btn btn-success">View</a></td>
